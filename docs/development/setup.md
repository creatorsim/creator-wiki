...
#### Web
We'll need to [launch the application in DEV mode](#compile-web-and-hot-reload-for-development-with-vite), and then attach the VS Code debugger to the Chrome instance.
```json
{
    "type": "chrome",
    "request": "launch",
