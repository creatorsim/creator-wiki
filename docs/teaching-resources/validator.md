...
!!! note
    We provide a [JSON schema](https://json-schema.org/) for the validator file at [https://creatorsim.github.io/creator/schema/validator-file.json](https://creatorsim.github.io/creator/schema/validator-file.json).
