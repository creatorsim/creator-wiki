...
![Architecture Select](img/selectarch.png){ loading=lazy }
/// caption
Architecture selection view for choosing processor architecture.
///
...
/// caption
Default view of the code editor with syntax highlighting.
///
...
![Simulator Default](img/simulator/default.png){ loading=lazy }
/// caption
Default simulator panel showing execution controls and tabs.
///
...
![Registers Space View](img/simulator/reg_spaceview.png){ loading=lazy }
/// caption
Registers tab displaying register values in space view mode.
///
...
![Simulator Memory](img/simulator/memory.png){ loading=lazy }
/// caption
Memory tab showing hexadecimal memory contents.
///

The hex editor also provides a memory layout diagram to help visualize different memory regions and their purposes.

![Simulator Memory Layout](img/simulator/memory_layout.png){ loading=lazy }
/// caption
Memory layout diagram showing different memory regions.
///
...
![Simulator Memory Data](img/simulator/memory_data.png){ loading=lazy }
/// caption
Memory viewer focused on data section.
///
...
![Simulator Terminal](img/simulator/terminal.png){ loading=lazy }
/// caption
Terminal tab showing a simple sum program interaction.
///
...
![Simulator Stats](img/simulator/stats.png){ loading=lazy }
/// caption
Statistics tab displaying execution metrics and performance data.
///
...
![Simulator Sentinel OK](img/simulator/sentinel_ok.png){ loading=lazy }
/// caption
Simulator panel with sentinel status OK, indicating successful execution.
///

![Simulator Sentinel Error](img/simulator/sentinel_err.png){ loading=lazy }
/// caption
Simulator panel with sentinel status Error, indicating a parameter passing violation.
///
...
![Architecture Instructions](img/architecture/instructions.png){ loading=lazy }
/// caption
...
![Architecture Pseudo](img/architecture/pseudo.png){ loading=lazy }
/// caption
...
![Architecture Directives](img/architecture/directives.png){ loading=lazy }
/// caption
Assembler directives available for the architecture.
///
...
![Architecture Registers](img/architecture/registers.png){ loading=lazy }
/// caption
Architecture panel showing available registers for the selected processor.
///
...
/// caption
Settings menu dropdown showing theme selection and other options.
///
