...
![Editor Auto-Completion](img/editor/autocomplete.png){ loading=lazy }
/// caption
Auto-completion suggestions for RISC-V instructions.
///

## Help Tooltips
Hover over instructions to see detailed help tooltips, including syntax, description, and usage examples.

![Editor Help Tooltip](img/editor/help.png){ loading=lazy }
/// caption
Help tooltip for the `ADD` instruction in RISC-V.
///
...
![Editor References](img/editor/references.png){ loading=lazy }
/// caption
Finding all references to a label in the code.
///
...
![Editor Error Indicators](img/editor/hovererror.png){ loading=lazy }
/// caption
Error and warning indicators in the editor.
///
...
![Editor Vim Mode](img/editor/vim.png){ loading=lazy }
/// caption
Vim mode enabled in the editor.
///
