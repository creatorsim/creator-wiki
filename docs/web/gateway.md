...
- [`esp32c3`](https://www.espressif.com/en/products/socs/esp32-c3)
    - [ESP32-C3-DevKitC-02](https://docs.espressif.com/projects/esp-dev-kits/en/latest/esp32c3/esp32-c3-devkitc-02/index.html) (JTAG, no port)
    - [ESP32-C3-DevKitM-1](https://docs.espressif.com/projects/esp-dev-kits/en/latest/esp32c3/esp32-c3-devkitm-1/index.html) (no JTAG)
- [`esp32c6`](https://www.espressif.com/en/products/socs/esp32-c6)
    - [ESP32-C6-DevKitC-1](https://docs.espressif.com/projects/esp-dev-kits/en/latest/esp32c6/esp32-c6-devkitc-1/index.html) (JTAG + port)
    - [ESP32-C6-DevKitM-1](https://docs.espressif.com/projects/esp-dev-kits/en/latest/esp32c6/esp32-c6-devkitm-1/index.html) (JTAG + port)
...
!!! tip
    ...
    ![JTAG connection](img/gateway/jtag-connection.png){ loading=lazy }
    /// caption
...
6. After the container confirms that GDBGUI is up and running, access the web interface at [http://localhost:5000](http://localhost:5000)
...
2. List all the devices in `Options` > `List All Devices` and select `USB Jtag/serial debug unit (Interface 2)`
    ...
    ![Setting the device in Zadig](img/gateway/zadig_set_device.png){ loading=lazy }
    /// caption
    Selecting the device in Zadig.
    ///

3. Downgrade the driver

    ![Downgrading the driver](img/gateway/zadig_downgrade_driver.png){ loading=lazy }
    /// caption
...
5. After the container confirms that GDBGUI is up and running, access the web interface at [http://localhost:5000](http://localhost:5000)
...
![ESP32 Gateway User Interface](img/gateway/ui.png){ loading=lazy }
/// caption
