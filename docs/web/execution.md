...
![Execution Controls](img/simulator/controls.png){ loading=lazy }
/// caption
Execution control buttons in the simulator panel.
///
...
![Breakpoint Example](img/simulator/breakpoint.png){ loading=lazy }
/// caption
...
![Interrupt handler](img/interrupt_handler.png){ loading=lazy }
/// caption
Modifying the interrupt handler.
///
