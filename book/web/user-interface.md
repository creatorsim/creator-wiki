...
![Editor Default](img/editor_default.png)
...
![Simulator Default](img/simulator_default.png)
...
![Registers Space View](img/simulator_reg_spaceview.png)
...
![Simulator Memory](img/simulator_memory.png)
...
![Simulator Memory Layout](img/simulator_memory_layout.png)
...
![Simulator Memory Data](img/simulator_memory_data.png)
...
![Simulator Terminal](img/simulator_terminal.png)
...
![Simulator Sentinel OK](img/simulator_sentinel_ok.png)
*Figure: Simulator panel with sentinel status OK, indicating successful execution.*

![Simulator Sentinel Error](img/simulator_sentinel_err.png)
...
![Architecture Instructions](img/architecture_instructions.png)
...
![Architecture Pseudo](img/architecture_pseudo.png)
...
![Architecture Directives](img/architecture_directives.png)
...
![Architecture Registers](img/architecture_registers.png)
